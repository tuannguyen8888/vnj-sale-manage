...
//                              }
            ...
            <div id='box_main' class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-danger" target="_blank" href="{{asset('uploads/templates/Import_san_pham_template.xlsx')}}"><i class="fa fa-download" aria-hidden="true"></i> Download template import sản phẩm</a>
                    </div>
                </div>
...
<!--                            <div class='callout callout-success'>
                        ...
                        <div class="box-footer">  
                          <div class='pull-right'>                            
                              ...
                              <input type='submit' class='btn btn-primary' name='submit' id='submit' value='Upload' onclick="showLoading();"/>
                          </div>
                        </div><!-- /.box-footer-->
                </form>
            </div><!-- /.box -->
