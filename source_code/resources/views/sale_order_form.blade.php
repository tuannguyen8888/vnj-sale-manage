		...
		<div class='panel panel-default'>
			...
			<div class="panel-body" id="parent-form-area">
				...
				<form method='post' action='{{CRUDBooster::mainpath('add-save')}}' id="form">
					...
					<div class="col-sm-10 hide_invalid_actual_weight">
					...
					<div class="col-sm-12 hide_invalid_actual_weight">
						<div class="form-group header-group-2">
							<table id="table_pays" class='table table-bordered'>
								...
								<tr class="bg-gray-active">
									<th colspan="6" class="text-center">Tổng tiền vàng + tiền công khách thanh toán</th>
									<th colspan="4" class="text-right" id="pay_total" style="padding-right: 13px;">0</th>
								</tr>
								</tfoot>
							</table>
						</div>
					...
					<div class="col-sm-8 hide_invalid_actual_weight">
						...
						<div class="form-group header-group-2">
							<table id="table_info" class='table table-bordered'>
								...
								<tr class="bg-info">
									...
									<th class="text-center" style="vertical-align: middle;width: 200px;">Ngày thu</th>
					...
					<div class="col-sm-4 hide_invalid_actual_weight"></div>
					<div class="col-sm-12 hide_invalid_actual_weight"></div>
					<div class="col-sm-8 hide_invalid_actual_weight">
