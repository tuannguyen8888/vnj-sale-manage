<?php namespace App\Http\Controllers;
	...
	class AdminGoldProductCategoriesController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gold_product_categories";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Tên loại hàng","name"=>"name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tên loại hàng','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-10','placeholder'=>'Nhập tên loại hàng'];
