<?php namespace App\Http\Controllers;
	...
	class AdminGoldStocksController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Tên kho hàng","name"=>"name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tên kho hàng','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-10','placeholder'=>'Nhập tên kho hàng'];
