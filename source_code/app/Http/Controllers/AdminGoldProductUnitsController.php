<?php namespace App\Http\Controllers;
	...
	class AdminGoldProductUnitsController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gold_product_units";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Tên đơn vị tính","name"=>"name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tên đơn vị tính','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-10','placeholder'=>'Nhập tên đơn vị tính'];
			...
			//$this->form[] = ["label"=>"Deleted By","name"=>"deleted_by","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			# OLD END FORM
