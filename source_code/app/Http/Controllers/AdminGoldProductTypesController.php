<?php namespace App\Http\Controllers;
	...
	class AdminGoldProductTypesController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gold_product_types";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Loại vàng","name"=>"name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Loại vàng','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-10'];
